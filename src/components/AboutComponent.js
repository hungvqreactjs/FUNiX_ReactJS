      ...
      <Card key={leaders.id}>
        <div className="row">
          ...
          <div className="col-lg-9 col-sm-8 col-12">
            <CardBody>
              <CardTitle><h3>{leaders.leaders.name} /  {leaders.leaders.abbr}</h3></CardTitle>
              <CardText>{leaders.leaders.designation}</CardText>
              <CardText>{leaders.leaders.description}</CardText>
            </CardBody>
          </div>
        </div>
      </Card>
